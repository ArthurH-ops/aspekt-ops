      ...
      <div className="container-wide relative z-10" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              {/* Project image */}
              <div className="aspect-[16/10] rounded-lg mb-6 overflow-hidden relative bg-secondary">
                <img
                  src={project.image}
                  alt={project.name}
        ...
        {/* Link to main site */}
        <div className={`mt-16 pt-8 border-t border-border text-center transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '600ms' }}>
          <a
